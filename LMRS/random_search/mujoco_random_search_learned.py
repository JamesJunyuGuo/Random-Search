...
class MujocoRandomSearchLearned(object):
    def __init__(self, params):
        ...
        # Initialize Ray without the deprecated argument
        ...
        self.train_stats = []
        self.eval_stats = []
        ray.init(num_cpus=params["num_workers"], ignore_reinit_error=True, dashboard_host=None)
    ...
    def evaluate(self, num_episodes):
        ...
        current_policy_to_save= self.policy.get_weights()
